        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              A portion of our work supports <strong>young adults aging out of foster care</strong> as they navigate one of life's most challenging transitions.
            </p>
            ...
            <p style={{
              ...
              Through partnerships with local organizations, we help provide:
            </p>
            ...
            <div style={{
              ...
              {[
                ...
                <div key={idx} style={{
                  ...
                  <Heart size={22} color="#3e8840" style={{ flexShrink: 0 }} />
                  <span style={{ fontSize: '1.05rem', color: '#323527', fontWeight: '500' }}>{item}</span>
                </div>
              ))}
            </div>
            
            <div style={{
              borderTop: '2px solid rgba(62, 136, 64, 0.2)',
              paddingTop: '2rem',
              textAlign: 'center'
            }}>
              <p style={{
                ...
                We believe healthy plants and healthy communities grow together. When you choose Plant Spa Co., 
                you're supporting both beautiful spaces and meaningful futures. 💚
              </p>
            </div>
          </div>
        </div>
